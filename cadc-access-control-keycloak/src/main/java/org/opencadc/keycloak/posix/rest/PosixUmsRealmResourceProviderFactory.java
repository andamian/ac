 ...
 */
public class PosixUmsRealmResourceProviderFactory implements RealmResourceProviderFactory {

    public static final String PROVIDER_ID = "posix";

    private PosixUmsConfig config;

    @Override
    public RealmResourceProvider create(KeycloakSession session) {
        return new PosixUmsRealmResourceProvider(session, config);
    }
