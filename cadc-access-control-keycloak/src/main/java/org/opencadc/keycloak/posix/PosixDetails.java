...
/**
 * POSIX account details assigned to a Keycloak user.
 */
public class PosixDetails {
    ...
    public PosixDetails(String username, int uid, int gid, String homeDirectory, String loginShell) {
        if (username == null) {
    ...
    public int hashCode() {
        ...
        result = prime * result + loginShell.hashCode();
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return loginShell.equals(other.loginShell);
    }
