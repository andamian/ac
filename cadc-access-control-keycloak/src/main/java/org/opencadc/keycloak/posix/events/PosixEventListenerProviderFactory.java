 ...
 */
public class PosixEventListenerProviderFactory implements EventListenerProviderFactory {

    public static final String PROVIDER_ID = "opencadc-posix";

    private PosixConfig config;

    @Override
    public EventListenerProvider create(KeycloakSession session) {
        return new PosixEventListenerProvider(session, config);
    }
