...
/**
 * Keycloak user attribute and LDAP attribute names for POSIX account details.
 */
public final class PosixAttributeNames {
    ...
    public static final String LDAP_POSIX_ACCOUNT = "posixAccount";

    private PosixAttributeNames() {
    }
}
